<template>
  <div v-if="state.speech" class="speech-col">
    <div class="speech-col-wrapper">
      <div class="box-wrapper">
        ...
        <div class="box-wrapper-content-wrapper">
          ...
          >
            <!-- S 输入语句 -->
            <speech-tip class="tip-space" style="color: #1b72f9">
              {{ state.speech.inputText }}
            </speech-tip>
            <!-- E 输入语句 -->
          </div>
    ...
    <subway-foot v-if="!state.isWidthScreen" class="subwayFoot" />
  </div>
</template>
...
export default {
  name: 'SpeechCardCol',
  components: { TtsGif, SpeechTip, SubwayFoot },
  props: {
    inputText: String,
    ...
    .box-wrapper {
      ...
      .box-wrapper-img-wrapper {
        ...
        .box-wrapper-img {
          width: 104px;
          height: 104px;
          background: url('~@/assets/images/icon-speech-col@2x.png') no-repeat
            center;
