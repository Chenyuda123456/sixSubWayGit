<template>
  <div
    :class="isPositionRight ? 'stepPayresult-style-right' : ''"
    class="stepPayresult display-flex-center van-row--align-center"
  >
    <div>
      <div
        v-if="ticketStatus?.errorList?.length && ticketStatus.sts === 999"
        class="pay-ticketing"
      >
      ...
      <div v-if="payCode == payMethods['cashMethod'] && ticketStatus.qrPicInfo">
